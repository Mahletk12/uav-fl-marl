...
For the MAPPO implementation, this repository provides modified environment components for our UAV-FL project. It is designed to work with the [light_mappo](https://github.com/tinyzqh/light_mappo) framework and adapts the environment logic for the UAV federated learning setting.
