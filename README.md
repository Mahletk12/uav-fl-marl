...
This repository also provides the modified environment components used in our UAV-FL project. The implementation is designed to work with the `light_mappo` framework and adapts the environment logic for the UAV federated learning setting.
